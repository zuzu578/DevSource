								...
								<td>
									<table width="100%" border="0" cellpadding="5" cellspacing="1"
										...
										<tr>
											...
											<option value="${paramMap.KofaGroupTitle}">전체</option>
												<c:forEach var="listResult" items="${collectionGroup}" varStatus="status">
													
													<option value="${listResult.cCollectionKofaGroupTitle }" >${listResult.cCollectionKofaGroupTitle } </option>
													</c:forEach>
										...
										<tr>
											...
											<td><select name="kofaUseYn" id="kofaUseYn">
													<option value="${paramMap.kofaUseYn}">전체</option>
													<c:forEach var="useYnFlag" items="${useYnFlag}" varStatus="status">
													
													<option value="${useYnFlag.useYn }" >${useYnFlag.useYn } </option>
													</c:forEach>
